...
Module.register("compliments", {
	...
	defaults: {
		compliments: {
			anytime: ["Welcome to PEPCODING", "HACK WITH PEP"],
			morning: ["Good morning, Be happy!", "Today's your day", "Never quit"],
			afternoon: ["Stay hydrated!!", "Get going, you will excel!!", "Precious treasure of afternoon"],
			evening: ["It was a productive day, take rest!", "Smile, you still have hope", "You have earned this evening!"],
